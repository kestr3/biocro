...
creator_map standardBML::module_library::library_entries =
    {
        {"aba_decay",
            &create_mc<aba_decay>},
        {"ball_berry",
            &create_mc<ball_berry>},
        {"biomass_leaf_n_limitation",
            &create_mc<biomass_leaf_n_limitation>},
        {"buck_swvp",
            &create_mc<buck_swvp>},
        {"bucket_soil_drainage",
            &create_mc<bucket_soil_drainage>},
        {"c3_assimilation",
            &create_mc<c3_assimilation>},
        {"c3_canopy",
            &create_mc<c3_canopy>},
        {"c3_leaf_photosynthesis",
            &create_mc<c3_leaf_photosynthesis>},
        {"c3_parameters",
            &create_mc<c3_parameters>},
        {"c4_assimilation",
            &create_mc<c4_assimilation>},
        {"c4_canopy",
            &create_mc<c4_canopy>},
        {"c4_leaf_photosynthesis",
            &create_mc<c4_leaf_photosynthesis>},
        {"canopy_gbw_thornley",
            &create_mc<canopy_gbw_thornley>},
        {"carbon_assimilation_to_biomass",
            &create_mc<carbon_assimilation_to_biomass>},
        {"cumulative_carbon_dynamics",
            &create_mc<cumulative_carbon_dynamics>},
        {"cumulative_water_dynamics",
            &create_mc<cumulative_water_dynamics>},
        {"development_index",
            &create_mc<development_index>},
        {"development_index_from_thermal_time",
            &create_mc<development_index_from_thermal_time>},
        {"example_model_mass_gain",
            &create_mc<example_model_mass_gain>},
        {"example_model_partitioning",
            &create_mc<example_model_partitioning>},
        {"format_time",
            &create_mc<format_time>},
        {"FvCB",
            &create_mc<FvCB>},
        {"golden_ratio_hyperbola",
            &create_mc<golden_ratio_hyperbola>},
        {"grimm_soybean_flowering",
            &create_mc<grimm_soybean_flowering>},
        {"grimm_soybean_flowering_calculator",
            &create_mc<grimm_soybean_flowering_calculator>},
        {"harmonic_energy",
            &create_mc<harmonic_energy>},
        {"harmonic_oscillator",
            &create_mc<harmonic_oscillator>},
        {"height_from_lai",
            &create_mc<height_from_lai>},
        {"hyperbola_2d",
            &create_mc<hyperbola_2d>},
        {"incident_shortwave_from_ground_par",
            &create_mc<incident_shortwave_from_ground_par>},
        {"leaf_evapotranspiration",
            &create_mc<leaf_evapotranspiration>},
        {"leaf_gbw_nikolov",
            &create_mc<leaf_gbw_nikolov>},
        {"leaf_shape_factor",
            &create_mc<leaf_shape_factor>},
        {"leaf_water_stress_exponential",
            &create_mc<leaf_water_stress_exponential>},
        {"light_from_solar",
            &create_mc<light_from_solar>},
        {"linear_vmax_from_leaf_n",
            &create_mc<linear_vmax_from_leaf_n>},
        {"litter_cover",
            &create_mc<litter_cover>},
        {"magic_clock",
            &create_mc<magic_clock>},
        {"maintenance_respiration",
            &create_mc<maintenance_respiration>},
        {"maintenance_respiration_calculator",
            &create_mc<maintenance_respiration_calculator>},
        {"Module_1",
            &create_mc<Module_1>},
        {"Module_2",
            &create_mc<Module_2>},
        ...
        {"night_and_day_trackers",
            &create_mc<night_and_day_trackers>},
        {"nr_ex",
            &create_mc<nr_ex>},
        {"one_layer_soil_profile",
            &create_mc<one_layer_soil_profile>},
        {"one_layer_soil_profile_derivatives",
            &create_mc<one_layer_soil_profile_derivatives>},
        {"oscillator_clock_calculator",
            &create_mc<oscillator_clock_calculator>},
        {"parameter_calculator",
            &create_mc<parameter_calculator>},
        {"partitioning_coefficient_logistic",
            &create_mc<partitioning_coefficient_logistic>},
        {"partitioning_coefficient_selector",
            &create_mc<partitioning_coefficient_selector>},
        {"partitioning_growth",
            &create_mc<partitioning_growth>},
        {"partitioning_growth_calculator",
            &create_mc<partitioning_growth_calculator>},
        {"partitioning_growth_calculator_leaf_costs",
            &create_mc<partitioning_growth_calculator_leaf_costs>},
        {"penman_monteith_leaf_temperature",
            &create_mc<penman_monteith_leaf_temperature>},
        {"penman_monteith_transpiration",
            &create_mc<penman_monteith_transpiration>},
        {"phase_clock",
            &create_mc<phase_clock>},
        {"poincare_clock",
            &create_mc<poincare_clock>},
        {"priestley_transpiration",
            &create_mc<priestley_transpiration>},
        {"rasmussen_specific_heat",
            &create_mc<rasmussen_specific_heat>},

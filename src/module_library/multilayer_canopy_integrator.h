   ...
   public:
    multilayer_canopy_integrator(
        ...
        : direct_module{},
          ...
          canopy_RL_CO2_op{get_op(output_quantities, "canopy_non_photorespiratory_CO2_release_rate_CO2")},
...
string_vector multilayer_canopy_integrator::get_outputs(int /*nlayers*/)
{
    return {
        ...
        "canopy_non_photorespiratory_CO2_release_rate_CO2",  // micromol CO2 / m^2 / s
...
void multilayer_canopy_integrator::run() const
{
    ...
    update(canopy_gross_assimilation_rate_CO2_op, canopy_gross_assimilation_rate);
    update(canopy_photorespiration_rate_CO2_op, canopy_photorespiration_rate);
    update(canopy_RL_CO2_op, canopy_RL);
